angular.module('myApp').service('service', function($http) {
  ...
  this.getVenueId = function(venue) {
    ...
    return $http({
      method: 'GET',
      url: 'https://api.jambase.com/venues?name=' + venue.text + '&page=0&api_key=m852p45q4hjqk85q6ety49zq',
    })
  }
// <<==========================================API KEYS==================================================>>
...
// <<============================================API KEYS================================================>>
  ...
  this.getVenueData = function(data) {
    ...
    return $http({
      method: 'GET',
      url: 'https://api.jambase.com/events?venueId=' + data + '&page=0&api_key=m852p45q4hjqk85q6ety49zq',
    })
  }
  ...
  this.getLocal = function(zip) {
    ...
    return $http({
      method: 'GET',
      url: 'https://api.jambase.com/events?zipCode=' + zip + '&page=0&api_key=m852p45q4hjqk85q6ety49zq'
    })
  }
})
